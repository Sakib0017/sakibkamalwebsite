    ...
    <div className="bg-gray-900 h-screen">
      ...
      <div className="grid sm:grid-cols-2 max-w-6xl mx-auto  rounded flex items-center justify-center mt-20 relative gap-5 " id="expertise">
        ...
        <p className="text-[15px] text-[#ffffff] font-bold">Software Developer(Frontend)</p>
          <p className="text-[32px] text-purple-300 font-bold">Hello Everybody, I'M</p>
        ...
        <div className="ms-auto colspan-1 text-start mt-8 relative mr-0">
          <img src={Sakib} alt="Sakib" className="h-[400px]  w-[350px] border-[1px] rounded border-purple-300 border-dashed" />
          </div>
